                    ...
                    <tbody class="align-middle">
                       ...
                       @foreach($cart as $cart)
                        ...
                        <tr>
                            ...
                            <td class="align-middle"><img src="/product/{{$cart->image}}" alt="" style="width: 100px;"></td>
                            ...
                            <td class="align-middle">
                                <div class="input-group quantity mx-auto" style="width: 100px;">
                                    ...
                                    <input type="text" name="quantity" class="form-control qty-input text-center" value="{{$cart->quantity}}">
                                    <div class="input-group-btn">
                            ...
                            <td class="align-middle">
                                <a href="{{url('remove_cart',$cart->id)}}" class="btn btn-sm btn-primary"><i class="fa fa-times"></i></a>
                            </td>
