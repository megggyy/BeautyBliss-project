...
<div class="row">
    <div class="col-md-12 grid-margin">
        ...
        <div class="card-header">
            ...
            <div class="card-body">
                <form action="{{ url('admin/products/'.$product->id)}}" method="POST" enctype="multipart/form-data" id="ProductFormValidation">
                @csrf
                @method('PUT')
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      ...
                      <li class="nav-item" role="presentation">
                        <button class="nav-link" id="colors-tab" data-bs-toggle="tab" data-bs-target="#colors-tab-pane" type="button" role="tab">Product Shades</button>
                      </li>
                  </ul>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3 d-flex align-items-center">
                                    ...
                                    <div class="form-check">
                                        <input type="checkbox" name="trending" {{ $product->trending == '1' ? 'checked' : '' }} class="form-check-input rounded-circle" style="width: 20px; height: 20px;">
                                    </div>
                                </div>
                                <div class="mb-3 d-flex align-items-center">
                                    <label class="me-5 mb-0">Status</label>
                                    <div class="form-check">
                                        <input type="checkbox" name="status" {{ $product->status == '1' ? 'checked' : '' }} class="form-check-input rounded-circle" style="width: 20px; height: 20px;">
                                    </div>
                                </div>
                            </div>
                        </div>
